...
int	rt_create(void*, uint32, uint32, uint32, char*, int32);

#define MAX_BOUNDED_JOBS 25
...
extern struct job bounded[26]; //last location is used for swapping
extern struct job good[25];
extern struct job bad[25];

extern int numBoundedJobs;
extern int numGood;
extern int numBad;

extern int doingBounded;
extern int executionBegan;
