...
extern void read_stats(char *path, unsigned int n, struct stat *stbuf);

extern void print_bits(void *ptr, int size);
extern int check_bit(void *ptr, int pos);
extern void set_bit(void *ptr, int pos, int value);
extern void sync_bitmaps();
extern void print_superblock();


extern unsigned int read_directory_fuse(char *path, unsigned int n, void *buf, fuse_fill_dir_t filler);
extern unsigned int fill_file(char *path, unsigned int n, unsigned int size, char *data);
